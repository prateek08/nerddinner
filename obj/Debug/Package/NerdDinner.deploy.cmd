...
set _DeploySetParametersFile=%RootPath%NerdDinner.SetParameters.xml
)
...
:usage
echo =========================================================
if not exist "%RootPath%NerdDinner.deploy-readme.txt" (
...
start notepad "%RootPath%NerdDinner.deploy-readme.txt"
)
echo =========================================================
goto :eof
